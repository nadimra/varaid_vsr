...
def generate_laplacian(savedir):
    ...
    for match in matches_l:
        ...
        for clip in clips_l:
            ...
            for sector in sector_l:
                ...
                sub_folder_laplacian = osp.join(sub_folder_name.replace('/HR/', '/HR_Laplacian/'))
                ...
                for img_HR_path in sorted(os.listdir(sub_folder_name)):
                    ...
                    sub_folder_laplacian_img = osp.join(imgSave.replace('/HR/', '/HR_Laplacian/'))
                    #print(sub_folder_laplacian_img)
                    cv2.imwrite(sub_folder_laplacian_img, im)


if __name__ == "__main__":
    generate_laplacian('/vol/bitbucket/nr421/Zooming-Slow-Mo-CVPR-2020/datasets/FootballVids/')