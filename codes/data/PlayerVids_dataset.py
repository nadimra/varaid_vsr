...
class PlayerVidsDataset(data.Dataset):
    '''
    Reading the training PlayerVids dataset
    key example: match026/0001/000001.png
    GT: Ground-Truth;
    ...
    def __init__(self, opt):
        super(PlayerVidsDataset, self).__init__()
        self.opt = opt
        ...
        if opt['cache_keys']:
            ...
            cache_keys = 'PlayerVids_train_keys.pkl'
    ...
    def __getitem__(self, index):
        ...
        for v in neighbor_list:
            if self.data_type == 'mc':
                ...
                img_GT = util.read_img(
                    self.GT_env, key + '_{}'.format(v), (3, 140, 279))
            else:
       ...
       # get LQ images
        LQ_size_tuple = (3,35, 69) if self.LR_input else (3,140, 279)
        img_LQ_l = []
